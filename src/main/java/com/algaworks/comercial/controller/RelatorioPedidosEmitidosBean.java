...
import com.algaworks.comercial.ireport.Relatorio;
import com.algaworks.comercial.util.service.FacesUtil;
...
public class RelatorioPedidosEmitidosBean implements Serializable {
	...
	public void emitir() {
		...
		Relatorio executor = new Relatorio("/relatorios/RelatorioEnfermagem.jasper",
